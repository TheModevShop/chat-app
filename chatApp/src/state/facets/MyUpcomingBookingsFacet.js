...
const loader = new RESTLoader({
  getResourceUrl: (queryParams = {}) => {
    ...
    return `${BASE}/me/bookings?start=${startDate}&end=${endDate}&limit=200&status=upcoming,cancelled&role=agent`; //may be able to get rid of instructor true, save on server
  },
